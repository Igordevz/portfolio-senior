export default function Projects({ index, project, setModal }: any) {
  return (
    ...
    <div
      className="flex flex-row w-full text-zinc-800 hover:text-black border-t-[0.5px] border-zinc-900 py-10 justify-between px-5 md:px-40 items-end hover:scale-[0.98] hover:rounded-md  transition-all hover:bg-orange-600"
      onMouseEnter={() => {
